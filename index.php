    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php
                if (($_SESSION['ADMIN'] || $_SESSION['PENGAJAR'] || $_SESSION['KEPSEK'] || $_SESSION['SISWA'])) {
                    echo "SELAMAT DATANG";
                ?>
                    &nbsp;
                ...
                ?>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="login_siswa.php">Login Siswa</a>
                            <a class="dropdown-item" href="login_pengajar.php">Login Guru</a>
                            <a class="dropdown-item" href="login_kepsek.php">Login Kepala sekolah</a>
                            <a class="dropdown-item" href="login_admin.php">Login Admin</a>
                        </div>
                    </div>
