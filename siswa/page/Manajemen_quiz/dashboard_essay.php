                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=Manajemen_quiz&aksi=edit_quiz_essay&id=<?php echo $data_topik_quiz['ID_ESSAY'] ?>&id_topik=<?php echo $data_topik_quiz['ID_TOPIK_QUIZ'] ?>" class="btn btn-success">Edit Topik</a>
