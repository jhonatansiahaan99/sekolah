<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Tugas/Quiz
            </h3>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=Manajemen_quiz&aksi=detail&id=<?php echo $data_mapel['ID_MAPEL'] ?>&id_kelas=<?php echo $tampil_siswa['ID_KELAS'] ?>" class="btn btn-primary">Lihat Tugas/Ujian</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
