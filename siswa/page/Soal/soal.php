            ...
            <input type=hidden name=id_topik value='$_POST[id]'>";
                                            ...
                                            while ($s = $soal->fetch_assoc()) {
                                                if ($s['GAMBAR'] != '') {
                                                    ...
                                                    echo "<td></td><td></td><img width='30%' height='30px' src='../images_soal_pilganda/$s[GAMBAR]' class='img-rounded'></td>";
                                                    echo "<td><p><input type=radio name=soal_pilganda[" . $s['ID_PILGANDA'] . "] value='A'>A. " . $s['PIL_A'] . "</p>";
    ...
    <table>";
                                            ...
                                            while ($e = $soal_esay->fetch_assoc()) {
                                                if (!empty($e['GAMBAR'])) {
                                                    ...
                                                    echo "<tr><td><img width='500px' height='500px' src='../images_soal_essay/$e[GAMBAR]'></td></tr>";
        ...
        <input type=hidden name=id_topik value='$_POST[id]'>";
                                            ...
                                            while ($s = $soal->fetch_assoc()) {
                                                if ($s['GAMBAR'] != '') {
                                                    ...
                                                    echo "<tr><td width='1%'></td> <td></td><td><img width='500px' height='500px' src='../images_soal_pilganda/$s[GAMBAR]' class='imh-rounded'></td></tr>";
