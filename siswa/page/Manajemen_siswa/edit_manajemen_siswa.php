...
if (isset($_POST['simpan'])) {
    if (empty($Asal_foto)) { //jika foto tidak di upload
        $database2 = $koneksi->query("update tbl_siswa set NIS='$Nis',NAMA_SISWA='$Nama_siswa',USERNAME='$Username',PASSWORD='$Password',ID_KELAS='$Kelas',ALAMAT='$Alamat',TEMPAT_LAHIR='$Tempat_lahir',TGL_LAHIR='$Tgl_lahir',JENKEL='$Jenkel',AGAMA='$Agama',NAMA_AYAH='$Nama_ayah',NAMA_IBU='$Nama_ibu',THN_MASUK='$Thn_masuk',EMAIL='$Email',TELP_ORTU='$Telp_ortu',TELP_SISWA='$Telp_siswa',STATUS_PENGGUNA='$Status_pengguna',USER_LEVEL='$User_level' where NIS='$ambil_perid' ");
            ...
            <div class="card card-primary">
                ...
                <form role="form" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Kelas</label>
                            <select name="kelas" value='$tampil[KELAS]' class="form-control" required>
                                <?php
