...
if (isset($_POST['simpan'])) {
    ...
    $database2 = $koneksi->query("update tbl_mapel set MAPEL='$Mapel',ID_KELAS='$Kelas',NIP_PENGAJAR='$Pengajar',DESKRIPSI='$Deskripsi' where ID_MAPEL = '$Id_mapel' ");
                        ...
                        <div class="form-group">
                            ...
                            <select name="pengajar" class="form-control" required>
                                ...
                                while ($data_pengajar = $database_pengajar->fetch_assoc()) {
                                    $kode_data_pengajar = $data_pengajar['NIP_PENGAJAR'];
