...
if (isset($_POST['simpan'])) {
    ...
    if ($Cek_user > 0) { ?>
        ...
        $database2 = $koneksi->query("insert into tbl_siswa (ID_SISWA,NIS,NAMA_SISWA,USERNAME,PASSWORD,ALAMAT,TEMPAT_LAHIR,TGL_LAHIR,JENKEL,AGAMA,NAMA_AYAH,NAMA_IBU,THN_MASUK,EMAIL,TELP_ORTU,TELP_SISWA,STATUS_PENGGUNA,USER_LEVEL) values('','$Nis','$Nama_siswa','$Username','$Password','$Alamat','$Tempat_lahir','$Tgl_lahir','$Jenkel','$Agama','$Nama_ayah','$Nama_ibu','$Thn_masuk','$Email','$Telp_ortu','$Telp_siswa','$Status_pengguna','$User_level')");
    ...
    <?php } elseif ($Error > 0) { ?>
        ...
        if (!empty($Asal_foto)) {
            ...
            $database2 = $koneksi->query("insert into tbl_siswa (ID_SISWA,NIS,NAMA_SISWA,USERNAME,PASSWORD,ALAMAT,TEMPAT_LAHIR,TGL_LAHIR,JENKEL,AGAMA,NAMA_AYAH,NAMA_IBU,THN_MASUK,EMAIL,TELP_ORTU,TELP_SISWA,FOTO,STATUS_PENGGUNA,USER_LEVEL) values('','$Nis','$Nama_siswa','$Username','$Password','$Alamat','$Tempat_lahir','$Tgl_lahir','$Jenkel','$Agama','$Nama_ayah','$Nama_ibu','$Thn_masuk','$Email','$Telp_ortu','$Telp_siswa','$Foto_baru','$Status_pengguna','$User_level')");
