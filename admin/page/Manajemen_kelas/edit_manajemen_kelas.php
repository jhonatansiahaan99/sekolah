...
if (isset($_POST['simpan'])) {
    ...
    $database2 = $koneksi->query("update tbl_kelas set KELAS='$Kelas',ID_PENGAJAR='$Wali_kelas', STATUS_KELAS='Tidak Aktif' where ID_KELAS = '$Id_kelas' ");
                        ...
                        <div class="form-group">
                            ...
                            <select name="wali_kelas" class="form-control" required>
                                ...
                                while ($data_wali_kelas = $database_wali_kelas->fetch_assoc()) {
                                    $kode_data_pengajar = $data_wali_kelas['ID_PENGAJAR'];
