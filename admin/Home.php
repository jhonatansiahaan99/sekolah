...
$database1 = $koneksi->query("SELECT * FROM tbl_admin where USERNAME = '$_SESSION[ADMIN]' ");
...
if (isset($_POST['simpan'])) {
    $database2 = $koneksi->query("update tbl_admin set USERNAME='$Username',PASSWORD='$Password',NAMA_LENGKAP='$Nama',USER_LEVEL='ADMIN',ALAMAT='$Alamat',TELP='$Telp',EMAIL='$Email',STATUS_USER='$Status' where USERNAME='$_SESSION[ADMIN]' ");
