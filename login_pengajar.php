...
if ($Login) {
    ...
    $database = $koneksi->query("select * from tbl_pengajar where  USERNAME = '$Username' AND PASSWORD='$Password' AND STATUS_PENGAJAR='Aktif' ");
    ...
    if ($ketemu >= 1) {
        session_start();
        if ($data['USER_LEVEL'] == "PENGAJAR") {
            $_SESSION['PENGAJAR'] = $data['USERNAME'];
            $_SESSION['ID_PENGAJAR'] = $data['ID_PENGAJAR'];
...
?>
            ...
            <script type="text/javascript">
                setTimeout(function() {
                    swal({
                        title: "SELAMAT DATANG PENGAJAR",
                        text: "Anda Berhasil Login",
                        type: "success",
                        showConfirmButton: false,
                        timer: 1000
                    }, function() {
                        window.location.href = "pengajar/index.php";
                    });
                }, 100);
            </script>
        <?php
        ...
        <script type="text/javascript">
            setTimeout(function() {
                swal({
                    ...
                    window.location.href = "login_pengajar.php";
