...
$Status_mapel = mysqli_real_escape_string($koneksi, $_POST['status_mapel']);

if (isset($_POST['simpan'])) {

    $database2 = $koneksi->query("update tbl_mapel set MAPEL='$Mapel',ID_KELAS='$Kelas',ID_PENGAJAR='$Pengajar',DESKRIPSI='$Deskripsi',STATUS_MAPEL='$Status_mapel' where ID_MAPEL = '$Id_mapel' ");
            ...
            <div class="card card-primary">
                ...
                <form role="form" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">Status Mata Pelajaran</label>
                            <div class="form-check">
                                <input name="status_mapel" type="radio" id="radio_1" value="Aktif" <?php if ($tampil['STATUS_MAPEL'] == 'Aktif') echo 'checked' ?> />
                                <label class="form-check-label">Aktif</label>
                            </div>
                            <div class="form-check">
                                <input name="status_mapel" type="radio" id="radio_2" value="Tidak Aktif" <?php if ($tampil['STATUS_MAPEL'] == 'Tidak Aktif') echo 'checked' ?> />
