...
if (isset($_POST['simpan'])) {
    ...
    $database = $koneksi->query("insert into tbl_mapel (MAPEL,ID_KELAS,ID_PENGAJAR,DESKRIPSI,STATUS_MAPEL) values('$Mapel','$Kelas','$Pengajar','$Deskripsi','Tidak Aktif')");
                        ...
                        <div class="form-group">
                            ...
                            <select name="pengajar" class="form-control" required>
                                ...
                                while ($data_pengajar = $database_pengajar->fetch_assoc()) {
                                    ...
                                    echo '<option value="' . $data_pengajar['ID_PENGAJAR'] . '" >' . $data_pengajar['NAMA_PENGAJAR'] . '</option>';
                                } ?>
