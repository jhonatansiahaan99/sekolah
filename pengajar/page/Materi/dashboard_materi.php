<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Materi Yang Anda Upload
            </h3>
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $database = $koneksi->query("SELECT * FROM tbl_materi INNER JOIN tbl_pengajar ON tbl_materi.ID_PENGAJAR = tbl_pengajar.ID_PENGAJAR INNER JOIN tbl_kelas ON tbl_materi.ID_KELAS = tbl_kelas.ID_KELAS INNER JOIN tbl_mapel ON tbl_materi.ID_MAPEL = tbl_mapel.ID_MAPEL where USERNAME='$_SESSION[PENGAJAR]' ");
