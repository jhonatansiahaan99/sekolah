...
if (isset($_POST['simpan'])) {
    $database = $koneksi->query("insert into tbl_kelas (KELAS,NIP_PENGAJAR) values('$Kelas','$Wali_kelas')");
                        ...
                        <div class="form-group">
                            ...
                            <select name="wali_kelas" class="form-control" required>
                                ...
                                while ($data_wali_kelas = $database_wali_kelas->fetch_assoc()) {
                                    ...
                                    echo '<option value="' . $data_wali_kelas['NIP_PENGAJAR'] . '" >' . $data_wali_kelas['NAMA_PENGAJAR'] . '</option>';
                                } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input name="status_kelas" class="form-check-input" type="radio" value="Aktif" checked>
                                <label class="form-check-label">Aktif</label>
                            </div>
                            <div class="form-check">
                                <input name="status_kelas" class="form-check-input" type="radio" value="Tidak Aktif">
